...
// @version     1.0
// @author      -
// @description 2024/7/12 22:05:26
// @license MIT
// ==/UserScript==
...
// 此处输入信息
var users = [
    {username: 'xiaoye10350@gmail.com', password: 'xiaoye10350的密码', secret: '3SUSZTFIYGWLCG长度大概是此长度二倍'},
    {username: 'xiaoye@gmail.com', password: 'xiaoye的密码', secret: '123456'},
    {username: 'xiaoye123@qq.com', password: 'xiaoye123的密码', secret: '123456'}
];
...
function checkUser(username) {
    var totpElement = document.createElement('p');
    totpElement.id = 'totp';
    document.body.appendChild(totpElement);
    // 填入用户名
    document.getElementsByName('username')[0].value = username;
    // 填入密码
    document.getElementsByName('password')[0].value = users.find(function (user) {
...
function generateTOTP(username) {
    ...
    var timeCode = totp.getOtp(
        // 根据用户名获取用户的 secret
        users.find(function (user) {
            return user.username === username;
        }).secret
    );
    // 在name为mfa_code的input中输入TOTP
    document.getElementsByName('mfa_code')[0].value = timeCode;
    console.log('填入的TOTP是：', timeCode);
    // 每隔1秒重新生成TOTP
...
!function (r) {
    ...
    function i(r, e) {
        ...
        for (n = 0; n < u; n += 3) for (h = n + 1 >>> 2, i = r.length <= h ? 0 : r[h], h = n + 2 >>> 2, w = r.length <= h ? 0 : r[h], o = (r[n >>> 2] >>> 8 * (3 - n % 4) & 255) << 16 | (i >>> 8 * (3 - (n + 1) % 4) & 255) << 8 | w >>> 8 * (3 - (n + 2) % 4) & 255, t = 0; t < 4; t += 1) 8 * n + 6 * t <= 32 * r.length ? d += "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(o >>> 6 * (3 - t) & 63) : d += e.b64Pad;
        return d
    }
            ...
            case"TEXT":
                h = function (r, n, t) {
                    return function (r, e, n, t) {
                        ...
                        if (a = n || [0], w = (t = t || 0) >>> 3, "UTF8" === e) for (h = 0; h < r.length; h += 1) for (l = [], 128 > (o = r.charCodeAt(h)) ? l.push(o) : 2048 > o ? (l.push(192 | o >>> 6), l.push(128 | 63 & o)) : 55296 > o || 57344 <= o ? l.push(224 | o >>> 12, 128 | o >>> 6 & 63, 128 | 63 & o) : (h += 1, o = 65536 + ((1023 & o) << 10 | 1023 & r.charCodeAt(h)), l.push(240 | o >>> 18, 128 | o >>> 12 & 63, 128 | o >>> 6 & 63, 128 | 63 & o)), i = 0; i < l.length; i += 1) {
                            for (d = (u = s + w) >>> 2; a.length <= d;) a.push(0);
                            a[d] |= l[i] << 8 * (3 - u % 4), s += 1
                        } else if ("UTF16BE" === e || "UTF16LE" === e) for (h = 0; h < r.length; h += 1) {
    ...
    function H(r) {
        var n = s(r, 28), t = s(r, 34), o = s(r, 39);
    ...
    function v(r) {
        var n = s(r, 14), t = s(r, 18), o = s(r, 41);
        return new e(n.highOrder ^ t.highOrder ^ o.highOrder, n.lowOrder ^ t.lowOrder ^ o.lowOrder)
    }
    ...
    function k(r) {
        var n, t, o;
        if ("SHA-1" === r && 1 & SUPPORTED_ALGS) n = [1732584193, 4023233417, 2562383102, 271733878, 3285377520]; else {
    ...
    function _(r, n, t) {
        ...
        if (("SHA-224" === t || "SHA-256" === t) && 2 & SUPPORTED_ALGS) O = 64, k = 1, Z = Number, D = C, G = L, _ = y, F = b, I = U, Y = A, N = T, K = p, j = c, V = M; else {
    ...
    var F = function (r, e, n) {
        ...
        if ("SHA-1" === A && 1 & SUPPORTED_ALGS) s = 512, f = D, O = G, l = 160; else if (6 & SUPPORTED_ALGS && (f = function (r, e) {
            return _(r, e, A)
        }, O = function (r, e, n, t) {
            return function (r, e, n, t, o) {
                var h, i, w, d, u;
                if (("SHA-224" === o || "SHA-256" === o) && 2 & SUPPORTED_ALGS) w = 15 + (e + 65 >>> 9 << 4), u = 16; else {
                ...
                if ("SHA-224" === o && 2 & SUPPORTED_ALGS) d = [t[0], t[1], t[2], t[3], t[4], t[5], t[6]]; else if ("SHA-256" === o && 2 & SUPPORTED_ALGS) d = t; else if ("SHA-384" === o && 4 & SUPPORTED_ALGS) d = [t[0].highOrder, t[0].lowOrder, t[1].highOrder, t[1].lowOrder, t[2].highOrder, t[2].lowOrder, t[3].highOrder, t[3].lowOrder, t[4].highOrder, t[4].lowOrder, t[5].highOrder, t[5].lowOrder]; else {
        ...
        }), "SHA-224" === A && 2 & SUPPORTED_ALGS) s = 512, l = 224; else if ("SHA-256" === A && 2 & SUPPORTED_ALGS) s = 512, l = 256; else if ("SHA-384" === A && 4 & SUPPORTED_ALGS) s = 1024, l = 384; else {
        ...
        o = k(A), this.setHMACKey = function (r, e, n) {
            ...
            if (!1 === H) for (o = O(p, E, S, o), t = 1; t < g; t += 1) o = O(o, l, 0, k(A));
            return H = !0, n(o)
